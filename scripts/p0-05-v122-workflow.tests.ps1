...
Assert-True ($realText.Contains('Get-P005V122OfficialContract')) 'real E2E must load the complete upstream lock contract'
Assert-True ($realText.Contains('Assert-P005V122OfficialContract')) 'real E2E must reject an invalid upstream lock contract'
